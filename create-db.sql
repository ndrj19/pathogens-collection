...
INSERT INTO `pathogens` (`pathogen_classification`,`species`,`aka`,`mortality_rate`,`deaths_per_year`,`year`,`good_to_know`,`image_link`) VALUES (1,"Yersinia pestis","Black death & Plague","22-100%",150000000,1317,"~60% of the European population were killed in the middle ages.","https://i.ibb.co/jwYN0KS/640px-Yersinia-pestis.jpg");
...
INSERT INTO `pathogens` (`pathogen_classification`,`species`,`aka`,`mortality_rate`,`deaths_per_year`,`year`,`good_to_know`,`image_link`) VALUES (2,"Influenza A: H1N1","Spanish Flu","2-25%",290000,1920,"Killed 25-50 million people.","https://i.ibb.co/SrKc2md/SARS-Co-V-2-viruses.jpg");
...
INSERT INTO `pathogens` (`pathogen_classification`,`species`,`aka`,`mortality_rate`,`deaths_per_year`,`year`,`good_to_know`,`image_link`) VALUES (3,"Naegleria fowleri","Brain-eating amoeba",">97%",8,2020,"Do not take a bath in The Roman Baths.","https://i.ibb.co/whYC4QS/brain-eating-amoeba.jpg");
