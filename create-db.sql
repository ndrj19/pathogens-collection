...
/* Use for demo
INSERT INTO `pathogens` (`pathogen_classification`,`species`,`aka`,`mortality_rate`,`deaths_per_year`,`year`,`good_to_know`,`image_link`) VALUES (3,"Trichinella spiralis","Trichinella","0.20%",200,2022,"The worms can infect the brain. Making them Brain worms.","https://i.ibb.co/pQS1Rxy/Trichinella-larv1-DPDx.jpg");
*/